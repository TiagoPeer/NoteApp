...
public class SimpleDatabase extends SQLiteOpenHelper {
    ...
    private static final String KEY_NUMBER_TIMES_EDITED = "numberTimesEdited";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createDb = "CREATE TABLE " + TABLE_NAME + " (" +
                ...
                KEY_DATE + " TEXT," +
                KEY_TIME + " TEXT," +
                KEY_NUMBER_TIMES_EDITED + " INTEGER"
                + " )";
        db.execSQL(createDb);
    }
    ...
    public long addNote(Note note) {
        ...
        v.put(KEY_NUMBER_TIMES_EDITED, note.getNumberTimesEdited());
    ...
    public Note getNote(long id) {
        SQLiteDatabase db = this.getWritableDatabase();
        String[] query = new String[]{KEY_ID, KEY_TITLE, KEY_CONTENT, KEY_DATE, KEY_TIME, KEY_NUMBER_TIMES_EDITED};
    ...
    public List<Note> getAllNotes() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                note.setNumberTimesEdited(cursor.getInt(5));
                allNotes.add(note);
    ...
    public int editNote(Note note) {
        ...
        c.put(KEY_NUMBER_TIMES_EDITED, note.getNumberTimesEdited());
